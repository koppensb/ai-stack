...
def settings():
    ...
    return {
        ...
        **{key: template for _, key, template in TASK_PROMPTS},
        ...
        "image_generation.model": os.environ.get("IMAGE_GENERATION_MODEL", "qwen-image-2.1-Q4_K_M.gguf"),
        ...
        "images.edit.model": os.environ.get("IMAGE_EDIT_MODEL", "qwen-image-2.1-Q4_K_M.gguf"),
